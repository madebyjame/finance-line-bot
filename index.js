...
const KW = {
  income: [
    'รายรับ','รับ','ได้','โอนเข้า','เงินเดือน','โบนัส','ทิป','ขายได้','ดอกเบี้ย','ปันผล',
    'รายได้','กำไร','ค่าจ้าง','ค่าจ้างรายวัน','รายได้เสริม','ได้เพิ่ม','ได้เงิน','ค่าคอม','commission',
    'ยอดโอนเข้า','ลูกค้าจ่าย','ได้คืน','เงินคืน','transfer in','inbound','เงินเข้า','โอนเข้าบัญชี'
  ],
  expense: [
    'รายจ่าย','จ่าย','ซื้อ','โอนออก','เติม','ค่าผ่อน','ผ่อน','ค่าสมาชิก','ค่าใช้จ่าย',
    'เสียเงิน','จ่ายตัง','จ่ายเงิน','ค่าใช้จ่ายรายวัน','ชำระ','ชำระเงิน','หักบัญชี','โอนออกบัญชี',
    'จ่ายบิล','ใช้จ่าย','ถอนเงิน','ตัดบัตร','รูดบัตร','สั่งซื้อ','shopping'
  ],
};
...
const CATS_EXPENSE = [
 { name: 'อาหาร/กาแฟ', kws: [
  // หมวดทั่วไป
  'ข้าว','อาหาร','ข้าวเที่ยง','ข้าวเย็น','ของกิน','กาแฟ','คาเฟ่','ชานม','ของหวาน','ส้มตำ','ก๋วยเตี๋ยว','หมูกระทะ',
  'ชา','ชาเขียว','ชานมไข่มุก','เบเกอรี่','เค้ก','ขนม','อาหารเช้า','ร้านอาหาร','อาหารกลางวัน','อาหารเย็น','มื้อเย็น',
  'ข้าวแกง','ไก่ทอด','เบอร์เกอร์','พิซซ่า','สเต็ก','บุฟเฟ่ต์','หมูกะทะ','ปิ้งย่าง','ซูชิ','อาหารญี่ปุ่น','อาหารเกาหลี',
  'น้ำผลไม้','ผลไม้','น้ำดื่ม','ขนมปัง','ของว่าง','คุกกี้','กาแฟดำ','ลาเต้','คาปูชิโน่','เอสเพรสโซ่','มอคค่า',
  'คาเฟ่ฮอปปิ้ง','อาหารเดลิเวอรี่','grabfood','foodpanda','lineman','โรบินฮู้ด','เดลิเวอรี่','อร่อย','กินข้าว','กินขนม',
  'กินกาแฟ','ไปกิน','ไปคาเฟ่','กินบุฟเฟ่ต์','มื้อกลางวัน','มื้อเย็น','สั่งอาหาร','ออเดอร์อาหาร','กินข้างนอก','ข้าวกล่อง',

  // เมนูยอดนิยมไทย
  'กะเพรา','ผัดกะเพรา','กระเพราไก่','กระเพราหมู','กระเพราหมูกรอบ','ไข่ดาว','ไข่เจียว','ผัดซีอิ๊ว','ราดหน้า','ข้าวผัด',
  'ข้าวมันไก่','ข้าวหมูแดง','ข้าวหมูกรอบ','ข้าวหน้าเป็ด','ข้าวขาหมู','ข้าวผัดกุ้ง','ข้าวผัดปู','ผัดไทย','หอยทอด','หมี่กรอบ',
  'ส้มตำ','ตำไทย','ตำปูปลาร้า','ไก่ย่าง','คอหมูย่าง','ลาบ','น้ำตก','ข้าวเหนียว','ไก่ทอด','ข้าวต้ม','โจ๊ก','ก๋วยเตี๋ยวเรือ',
  'เย็นตาโฟ','บะหมี่','บะหมี่หมูแดง','บะหมี่เกี๊ยว','เกาเหลา','ต้มยำ','ข้าวแกง','ผัดขี้เมา','ผัดพริกแกง','ข้าวราดแกง',
  'แกงเขียวหวาน','แกงเผ็ด','แกงส้ม','แกงจืด','ต้มจืด','ต้มยำกุ้ง','ข้าวหมูกระเทียม','ผัดผงกะหรี่','ข้าวไข่ข้น',
  'สปาเกตตี้','มักกะโรนี','เฟรนช์ฟราย','ไก่ป๊อป','นักเก็ต','ไก่ทอดเกาหลี','ไก่กรอบ','เบอร์เกอร์หมู','เบอร์เกอร์เนื้อ',
  'ข้าวหมูทอด','หมูทอดกระเทียม','หมูปิ้ง','ลูกชิ้น','ไส้กรอก','ข้าวหน้าไก่','อาหารตามสั่ง','ข้าวกล่อง',
  
  // อาหารญี่ปุ่น/เกาหลี/จีน/ฝรั่ง
  'ข้าวหน้าเนื้อ','ข้าวหน้าหมู','ข้าวหน้าแซลมอน','ข้าวหน้าปลาไหล','ซาซิมิ','ซูชิ','ซูชิโรล','ราเมน','อุด้ง','เทมปุระ',
  'ข้าวแกงกะหรี่','ทงคัตสึ','เกี๊ยวซ่า','คิมบับ','บิบิมบับ','ซุปกิมจิ','ไก่ทอดเกาหลี','ต๊อกบกกี','บะหมี่เกาหลี','ราเมง',
  'ติ่มซำ','ขนมจีบ','ซาลาเปา','เป็ดย่าง','หมูกรอบฮ่องกง','เกี๊ยวน้ำ','โจ๊กฮ่องกง','หมั่นโถว',
  'สเต็ก','พาสต้า','สลัด','ขนมปัง','แซนด์วิช','ซุป','มันบด','ฟิชแอนด์ชิปส์','ไส้กรอกเยอรมัน','ข้าวผัดอเมริกัน',
  
  // เครื่องดื่ม
  'กาแฟเย็น','กาแฟร้อน','อเมริกาโน่','ลาเต้','คาปูชิโน่','มอคค่า','เอสเพรสโซ่','โกโก้','ช็อกโกแลต','นมสด','นมเย็น',
  'ชาเย็น','ชาเขียว','ชาไทย','ชามะนาว','ชาดำ','ชาใส่นม','ชาผลไม้','น้ำผลไม้','น้ำส้ม','น้ำแตงโม','น้ำมะพร้าว','น้ำลิ้นจี่',
  'น้ำองุ่น','น้ำแดง','น้ำเขียว','สมูทตี้','ชานมไข่มุก','ไข่มุก','brown sugar','กาแฟดริป','cold brew','iced coffee',
  'กาแฟส้ม','กาแฟมะพร้าว','กาแฟอัญชัน','ชาใบบัวบก','ชาข้าวหอม','ชาไทยโบราณ','โอเลี้ยง','นมชมพู','นมเย็น','โกโก้เย็น',
  
  // ของหวาน/ขนม
  'ขนมไทย','ขนมชั้น','ทองหยิบ','ทองหยอด','ฝอยทอง','บัวลอย','ลอดช่อง','ข้าวเหนียวมะม่วง','เฉาก๊วย','ไอศกรีม','พุดดิ้ง',
  'เค้ก','โดนัท','ขนมปัง','วาฟเฟิล','แพนเค้ก','โทสต์','บราวนี่','มาการอง','คุ้กกี้','ขนมครก','ขนมถ้วย','โรตี','ขนมหม้อแกง',
  'ของหวาน','ขนมหวาน','dessert','sweet','เบเกอรี่','เบเกอรี่คาเฟ่','ร้านขนม','ร้านเค้ก','ร้านกาแฟ','ร้านคาเฟ่','coffee shop',
  
  // เดลิเวอรี่และแพลตฟอร์ม
  'grabfood','foodpanda','lineman','robinhood','เดลิเวอรี่','ส่งอาหาร','สั่งอาหาร','ออเดอร์','ออร์เดอร์','delivery',
  'ส่งข้าว','สั่งข้าว','แกร็บฟู้ด','ฟู้ดแพนด้า','โรบินฮู้ด','ส่งจากร้าน','แอปอาหาร','แอพอาหาร',
  
  // สำนวนทั่วไป
  'กิน','ไปกิน','กินข้าว','กินขนม','กินกาแฟ','หิว','อยากกิน','ทานข้าว','ไปทาน','ทานอาหาร','กินมื้อเที่ยง','กินมื้อเย็น',
  'กินกับเพื่อน','เลี้ยงข้าว','ซื้ออาหาร','ซื้อข้าว','ออกไปกิน','จ่ายค่าอาหาร','ค่าอาหาร','จ่ายกาแฟ','ซื้อกาแฟ','จ่ายคาเฟ่',
  'ดื่มกาแฟ','ดื่มชา','ดื่มน้ำ','ดื่มนม','กินข้าวนอกบ้าน','กินที่ร้าน','กินคนเดียว','กินกับครอบครัว'
]},
{ 
  name: 'เดินทาง', 
  kws: [
    'รถ','รถยนต์','มอเตอร์ไซค์','มอไซค์','น้ำมัน','เติมน้ำมัน','ดีเซล','เบนซิน','แก๊ส','ค่าเดินทาง',
    'บีทีเอส','mrt','รถไฟ','รถไฟใต้ดิน','รถไฟฟ้า','รถเมล์','แท็กซี่','แกร็บ','grab','bolt','inDrive','รถสองแถว',
    'ค่าแท็กซี่','ค่ารถ','ค่าทางด่วน','ทางด่วน','ค่าจอดรถ','ที่จอดรถ','ตั๋วรถ','ตั๋วเครื่องบิน','เครื่องบิน',
    'บิน','สนามบิน','เดินทาง','เดินทางไปทำงาน','เดินทางกลับบ้าน','ขับรถ','uber','ค่าน้ำมัน','เช่ารถ','เช่ามอเตอร์ไซค์',
    'ขนส่ง','รถรับส่ง','เรือ','ค่าเรือ','รถตู้','ตั๋วเรือ','เที่ยวต่างจังหวัด','ค่าทาง','ค่าจราจร'
  ] 
},
...
{ 
  ...
  kws: [
    'ค่าไฟ','ค่าน้ำ','ค่าเน็ต','ค่าอินเทอร์เน็ต','อินเตอร์เน็ต','ค่าโทร','โทรศัพท์','มือถือ','โทรรายเดือน','เน็ตบ้าน',
    'wifi','ไวไฟ','ค่าเช่า','ค่าเช่าบ้าน','ค่าเช่าคอนโด','ค่าห้อง','ค่าเช่าห้อง','คอนโด','หอพัก','บ้านเช่า',
    'ค่าน้ำประปา','ค่าสาธารณูปโภค','ค่าแก๊ส','ค่าน้ำมันเครื่อง','ค่าส่วนกลาง','ค่าส่วนกลางคอนโด','ค่าขยะ','ค่าบำรุง',
    'จ่ายบิล','บิลค่าไฟ','บิลค่าน้ำ','บิลมือถือ','บิลเน็ต','ค่าประปา','ค่าน้ำดื่ม','ค่าเคเบิล','true','ais','dtac','3bb','fiber'
  ] 
},
...
{ 
  ...
  kws: [
    'ช้อป','ช้อปปิ้ง','ช็อป','ซื้อของ','ของใช้','สั่งของ','ของใช้ส่วนตัว','เครื่องสำอาง','ครีม','ลิป','เสื้อ','กางเกง','รองเท้า',
    'กระเป๋า','แว่น','นาฬิกา','เครื่องประดับ','ของตกแต่ง','ของขวัญ','ของฝาก','ของเล่น','เครื่องเขียน',
    'shopee','lazada','tiktokshop','jd','amazon','ebay','สั่งออนไลน์','ซื้อออนไลน์','ของในบ้าน','ผ้า','ผ้าขนหนู',
    'เครื่องใช้ไฟฟ้า','ทีวี','ตู้เย็น','พัดลม','เตารีด','เครื่องซักผ้า','หูฟัง','โทรศัพท์ใหม่','อุปกรณ์เสริม','สายชาร์จ','powerbank',
    'อุปกรณ์ครัว','จาน','ชาม','หม้อ','กระทะ','ของแต่งห้อง','เฟอร์นิเจอร์','ikea','homepro','index','โลตัส','บิ๊กซี','แม็คโคร'
  ] 
},
...
{ 
  name: 'สุขภาพ/ประกัน', 
  kws: [
    'ยา','โรงพยาบาล','คลินิก','ตรวจสุขภาพ','รักษา','ค่ารักษา','หมอ','ค่ายา','ฟัน','ทำฟัน','หมอฟัน','แว่นตา','เลนส์','คอนแทคเลนส์',
    'ฟิตเนส','ยิม','ออกกำลังกาย','โยคะ','วิ่ง','ตรวจโรค','ฉีดวัคซีน','วัคซีน','ตรวจเลือด','ตรวจร่างกาย','อุบัติเหตุ','ประกัน','ประกันชีวิต',
    'ประกันสุขภาพ','ประกันรถ','ประกันเดินทาง','ค่าหมอ','ค่ารักษาพยาบาล','ค่ายา','คลินิกเสริมสวย','นวด','สปา','เวชภัณฑ์','อาหารเสริม','วิตามิน'
  ] 
},
...
{ 
  name: 'การศึกษา/งาน', 
  kws: [
    'คอร์ส','เรียน','เรียนออนไลน์','หลักสูตร','อบรม','สัมนา','ค่าสมัคร','ค่าสอบ','หนังสือ','ตำรา','โน้ต','อีบุ๊ก','e-book',
    'ค่าเทอม','โรงเรียน','มหาวิทยาลัย','ติว','ติวเตอร์','เรียนพิเศษ','ภาษาอังกฤษ','ภาษาญี่ปุ่น','ภาษาจีน','เรียนออกแบบ','เรียนโค้ด','เรียนเขียนโปรแกรม',
    'workshop','สัมมนา','คอร์สออนไลน์','udemy','skilllane','coursera','microsoft','adobe','autocad','licence','subscription','สมัครใช้โปรแกรม','ค่าโปรแกรม','ค่าโดเมน','hosting'
  ] 
},
...
{ 
  name: 'บันเทิง', 
  kws: [
    'หนัง','ดูหนัง','โรงหนัง','netflix','disney+','viu','iflix','spotify','joox','apple music','youtube premium',
    'เกม','เกมส์','เติมเกม','เติมเกมส์','steam','playstation','ps5','xbox','nintendo','mobile game',
    'คอนเสิร์ต','ตั๋วคอนเสิร์ต','ดูคอนเสิร์ต','อีเวนต์','งานแฟร์','เที่ยว','ท่องเที่ยว','รีสอร์ท','โรงแรม','ค่าที่พัก','ค่าท่องเที่ยว',
    'ผับ','บาร์','เหล้า','เบียร์','คาราโอเกะ','ร้องเพลง','hangout','ดูซีรีส์','ดูละคร','อ่านการ์ตูน','manga','anime','หนังสือการ์ตูน'
  ] 
},
...
const CATS_INCOME = [
  { name: 'เงินเดือน', kws: [
    'เงินเดือน','salary','เดือนนี้','ค่าจ้าง',
    'รายได้ประจำ','รับเงินเดือน','โอนเงินเดือน','เงินออก','เงินเข้าบัญชี','เงินเดือนเข้า',
    'ค่าทำงาน','ค่าจ้างประจำ','รายได้จากงาน','ค่าตอบแทน','เงินเดือนออก','slip เงินเดือน'
  ]},
  { name: 'โบนัส/ทิป', kws: [
    'โบนัส','bonus','ทิป','tip',
    'เงินพิเศษ','เงินขอบคุณ','เงินรางวัล','โบนัสสิ้นปี','โบนัสกลางปี','ได้โบนัส','ทิปจากลูกค้า','ลูกค้าให้ทิป'
  ]},
  { name: 'ขายของ', kws: [
    'ขาย','ยอดขาย','ออเดอร์','commission','ค่าคอม',
    'ขายของ','ขายได้','ขายออนไลน์','ขายของใน shopee','ขายของใน lazada','ขายของ tiktok','ขายหน้าร้าน',
    'ขายสินค้า','ขายเสื้อ','ขายรองเท้า','ขายของเล่น','ขายอาหาร','ขายกาแฟ','ขายขนม','ขายต่อ','ขายมือสอง',
    'รายได้จากการขาย','ขายของได้','ยอดโอนลูกค้า','เงินจากลูกค้า'
  ]},
  { name: 'การเงิน/ลงทุน', kws: [
    'ดอกเบี้ย','ปันผล','หุ้น','คริปโต',
    'crypto','bitcoin','eth','หุ้นปันผล','กำไรหุ้น','กำไรเทรด','เทรด','เทรดหุ้น','ลงทุน','การลงทุน',
    'กองทุน','กองทุนรวม','ผลตอบแทน','ดอกเบี้ยเงินฝาก','ฝากธนาคาร','รับดอกเบี้ย','กำไรลงทุน',
    'ขายหุ้น','ขายกองทุน','รายได้จากการลงทุน','เงินปันผล'
  ]}
];
...
สรุปแบบมืออาชีพ กระชับ ไม่เกิน 100 คำ ใช้ bullet point อ่านง่าย ห้ามใช้สัญลักษณ์ตกแต่ง
ให้ตอบ 3 ส่วน:
- เดือนล่าสุดใช้จ่ายสูงสุดหมวดใด และประมาณเท่าไร
- คำแนะนำสั้นๆ ที่ทำได้จริง 2–3 ข้อ
- หากต้องออมเดือนละ 3,000 บาท ควรลดหมวดใดจึงกระทบน้อยสุด
พูดเหมือนคนให้คำปรึกษาเรื่องเงิน เข้าใจง่าย ไม่เยิ่นเย้อ
...
- เทียบเดือนต่อเดือน ${monthsKeys}: รายรับเปลี่ยน ${momInc.toLocaleString()} รายจ่ายเปลี่ยน ${momExp.toLocaleString()}
