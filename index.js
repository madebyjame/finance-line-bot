...
- ข้อเสนอ 3 ข้อที่ทำได้จริง
- สรุปสถานะ: ปกติ / ควรเฝ้าดู / ควรปรับ

หมายเหตุ: 
ห้ามใส่สัญลักษณ์ ** หรือ Markdown ใด ๆ ในคำตอบ 
ให้ตอบเป็นข้อความธรรมดาเท่านั้น ไม่ต้องใช้ตัวหนา ตัวเอียง หรือ bullet point ที่มีสัญลักษณ์พิเศษ
`.trim();
